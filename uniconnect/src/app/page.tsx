  ...
  return (
    <main className="flex max-h-screen items-center bg-white justify-between p-24">
      ...
      <div className="relative flex flex-col text-gray-700 bg-transparent shadow-xl p-5 rounded-xl bg-clip-border">
        ...
        <form className="max-w-screen-lg mt-2 mb-2 w-80 sm:w-96">
          <div className="flex flex-col gap-3 mb-1">
            <h6
              className="block -mb-3 font-sans text-sm antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
              Your Email
            </h6>
            ...
            <h6
              className="block -mb-1 font-sans text-sm antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
              Password
            </h6>
            <div className="relative h-8 w-full min-w-[200px]">
          ...
          <div className="inline-flex items-center">
            ...
            <label className="mt-px font-light text-gray-700 cursor-pointer select-none" htmlFor="remember">
              <p className="flex items-center font-sans text-xs antialiased font-normal leading-normal text-gray-700">
                I agree the
          ...
          <button
            onClick={()=> router.push(appRoutes.feed)}
